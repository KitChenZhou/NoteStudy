...
public class WeatherFragment extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        Log.d("Weather", "LifeCycle：WeatherFragment_onAttach");
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.d("Weather", "LifeCycle：WeatherFragment_onCreate");
    }
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (weatherId != null) {
                    ...
                    Log.d("Weather", "LifeCycle：swipeWeatherId is null");
                }

            }
        });
        Log.d("Weather", "LifeCycle：WeatherFragment_onCreateView");
        return view;
    }
    ...
    public void onResume() {
        ...
        if (weatherId != null) {
            ...
            Log.d("Weather", "LifeCycle：WeatherId is null");
        }
        Log.d("Weather", "LifeCycle：WeatherFragment_onResume");
    }
    ...
    public void onDetach() {
        super.onDetach();
//        weatherId=null;
        Log.d("Weather", "LifeCycle：WeatherFragment_onDetach");
