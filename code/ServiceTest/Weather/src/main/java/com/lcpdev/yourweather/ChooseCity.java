...
//    private TextView titleText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        initToolbar();
        Log.d("Weather","LifeCycle：ChooseActivity_onCreate");
    }

    @Override
    protected void onStart() {
        super.onStart();
        Log.d("Weather","LifeCycle：ChooseActivity_onStart");
    }

    @Override
    protected void onResume() {
        super.onPostResume();
        Log.d("Weather","LifeCycle：ChooseActivity_onResume");
    }

    @Override
    protected void onPause() {
        super.onPause();
        Log.d("Weather","LifeCycle：ChooseActivity_onPause");
    }

    @Override
    protected void onStop() {
        super.onStop();
        Log.d("Weather","LifeCycle：ChooseActivity_onStop");
    }
...
//        queryProvince();
    ...
    private void queryCounty() {
        ...
        if (countyList.size() > 0) {
            ...
            Log.d("Weather","queryCounty" + address);
    ...
    protected void onDestroy() {
        super.onDestroy();
        Log.d("Weather","LifeCycle:ChooseActivity_onDestroy");
    }
}
