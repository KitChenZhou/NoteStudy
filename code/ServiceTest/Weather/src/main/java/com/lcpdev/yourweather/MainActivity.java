...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("Weather", "LifeCycle：MainActivity_OnCreate");
    }

    @Override
    protected void onStart() {
        super.onStart();
        Log.d("Weather", "LifeCycle：MainActivity_OnStart");
    ...
    protected void onResume() {
        ...
        Log.d("Weather", "LifeCycle：MainActivity_OnResume");
    }
    ...
    protected void onRestart() {
        super.onRestart();
        Log.d("Weather", "LifeCycle：MainActivity_OnRestart");
    }
    ...
    protected void onPause() {
        super.onPause();
        Log.d("Weather", "LifeCycle：MainActivity_OnPause");
    }

    @Override
    protected void onStop() {
        super.onStop();
        Log.d("Weather", "LifeCycle：MainActivity_OnStop");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        Log.d("Weather", "LifeCycle：MainActivity_OnDestroy");
    }
                ...
                if (amapLocation != null) {
                    if (amapLocation.getErrorCode() == 0) {
                        ...
                        if (!TextUtils.isEmpty(city)) {
                            ...
                            Log.i("Weather", "定位成功：当前城市为" + cityName);
