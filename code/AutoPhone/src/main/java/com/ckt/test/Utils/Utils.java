...
public class Utils {
     ...
     */
    public static void exportFile(final Context context, final ArrayList<CallRecord> callRecordList) {
        ...
        if (ActivityCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            dialog.setPositiveButton("继续", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    SaveToExcelUtil.writeToExcel(file, callRecordList);//写数据到表格
     ...
     */
    public static void getReport(Context context, ArrayList<CallRecord> callRecordList) {
        ...
        dialog.setMessage("成功拨打次数： " + validCall + "\n"
                + "失败拨打次数： " + (callRecordList.size() - validCall) + "\n"
                + "总计拨打次数： " + callRecordList.size() + "\n"
                + "      呼通率      ： " + (validCall * 1.0) / callRecordList.size() * 100 + "%");
