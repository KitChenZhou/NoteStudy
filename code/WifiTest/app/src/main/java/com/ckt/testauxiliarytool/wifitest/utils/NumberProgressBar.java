package com.ckt.testauxiliarytool.wifitest.utils;
...
import com.ckt.testauxiliarytool.wifitest.R;

import static com.ckt.testauxiliarytool.wifitest.utils.NumberProgressBar.ProgressTextVisibility.Invisible;
import static com.ckt.testauxiliarytool.wifitest.utils.NumberProgressBar.ProgressTextVisibility.Visible;
...
public class NumberProgressBar extends View {
    ...
    private void calculateDrawRectF() {
        ...
        mCurrentDrawText = String.format("%.1f", getProgress() * 100.0 / getMax());
